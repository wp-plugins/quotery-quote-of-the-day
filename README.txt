...
2. Search for 'Quotery: Quote of The Day'
3. Click 'Install Now'
...
3. Select `quotery-quote-of-the-day.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `quotery-quote-of-the-day.zip`
2. Extract the `quotery-quote-of-the-day` directory to your computer
3. Upload the `quotery-quote-of-the-day` directory to the `/wp-content/plugins/` directory
